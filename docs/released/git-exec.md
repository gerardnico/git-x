...
* `GIT_X_REPOS_DIRS`: One or more directories separated by `:` where all sub-repositories are git repositories
...
export GIT_X_REPOS_DIRS=$HOME/code/orga1:$HOME/code/orga2
